...
# Load data
# ======================
train = pd.read_feather("Cleanbot1.0_train.feather")
val   = pd.read_feather("Cleanbot1.0_validation.feather")
...
trainer.train()
trainer.save_model("./results_cleanbot1")
...
pd.DataFrame([metrics]).to_csv(
    "./results_cleanbot1/metrics.csv", index=False
)
